...
#define ETH_SPI_CS_Pin GPIO_PIN_4
#define ETH_SPI_CS_GPIO_Port GPIOA
#define ETH_SPI_SCK_Pin GPIO_PIN_5
#define ETH_SPI_SCK_GPIO_Port GPIOA
...
#define ETH_ON_Pin GPIO_PIN_13
#define ETH_ON_GPIO_Port GPIOB
